...
print(t_loops)
print(table)
#p_loops = node dans pattern impliqué dans une self-loop 
#t_loops = node dans target impliqué dans une self-loop
#table = edge arc entrant et arc sortant dans target
#degree_conflicts= pour chaque noeud du pattern, set des noeud du target dont le degrée est inférieur à celui du pattern
